...
export interface LivelineProps {
  ...
  minRange?: number         // Floor on the y-axis span; stops a near-flat window from zooming until tiny ticks fill the canvas
  nowOverride?: number      // Pin the window's right edge to this unix-seconds time instead of Date.now() (for frozen/historical views)
